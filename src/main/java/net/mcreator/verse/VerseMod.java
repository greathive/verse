...
@Mod("verse")
public class VerseMod {
	public static final Logger LOGGER = LogManager.getLogger(VerseMod.class);
	public static final String MODID = "verse";

	public VerseMod(IEventBus modEventBus) {
		...
		VerseModAttributes.REGISTRY.register(modEventBus);
