...
import net.mcreator.verse.procedures.AnkleWeightsItemInInventoryTickProcedure;
...
public class AnkleWeightsItem extends Item {
	...
	public InteractionResultHolder<ItemStack> use(Level world, Player entity, InteractionHand hand) {
		...
		AnkleWeightsRightclickedProcedure.execute(world, entity.getX(), entity.getY(), entity.getZ(), ar.getObject());
		return ar;
	}
	...
	public void inventoryTick(ItemStack itemstack, Level world, Entity entity, int slot, boolean selected) {
		...
		AnkleWeightsItemInInventoryTickProcedure.execute(world, entity, itemstack);
	}
}