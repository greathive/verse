...
public class Addpoint8Procedure {
	public static void execute(LevelAccessor world, double x, double y, double z, Entity entity) {
		...
		String stat2 = "";
		stat = "";
		if (entity.getData(VerseModVariables.PLAYER_VARIABLES).Thundercall > 100) {
			stat = "thundercall";
		} else if (entity.getData(VerseModVariables.PLAYER_VARIABLES).Frostdraw > 100) {
			stat = "frostdraw";
