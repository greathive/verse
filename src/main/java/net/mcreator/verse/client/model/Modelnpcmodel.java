...
public class Modelnpcmodel<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath("verse", "modelnpcmodel"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition right_item = right_arm.addOrReplaceChild("right_item", CubeListBuilder.create(), PartPose.offset(-1.0F, 7.75F, -2.0F));
		PartDefinition left_arm = body.addOrReplaceChild("left_arm",
				...
				PartPose.offset(5.0F, -10.0F, 0.0F));
		PartDefinition left_item = left_arm.addOrReplaceChild("left_item", CubeListBuilder.create(), PartPose.offset(1.0F, 7.75F, -2.0F));
